...
mod imp {
    ...
    #[properties(wrapper_type=super::SpeedTestResultsView)]
    #[template(resource = "/io/github/nacho/mecalin/ui/speed_test_results_view.ui")]
    pub struct SpeedTestResultsView {
        #[template_child]
    ...
    impl ObjectSubclass for SpeedTestResultsView {
        const NAME: &'static str = "SpeedTestResultsView";
        type Type = super::SpeedTestResultsView;
        type ParentType = gtk::Widget;

        fn class_init(klass: &mut Self::Class) {
            klass.set_css_name("SpeedTestResultsView");
    ...
    impl ObjectImpl for SpeedTestResultsView {
